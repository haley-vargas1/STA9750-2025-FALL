---
title: "Final Project Individual Report: Kitchen Nightmares 🔪"
author: "Haley Vargas"
date: today
format:
  html:
...
This report outlines the analytical workflow used in this project; specifically, for question 3: "Do neighborhoods with higher obesity or diabetes rates have a higher percentage of American cuisines according to DOHMH data?"
...
ZIP codes from the inspection dataset are mapped to NYC neighborhood groupings from CHP data to create a consistent geographic unit across datasets.
...
The scatter plot shows the relationship between neighborhood-level obesity rates and the percentage of American cuisine restaurants in NYC. While the fitted regression line indicates a slight positive trend—suggesting that neighborhoods with higher obesity rates may have a marginally higher proportion of American cuisine restaurants—the spread of points around the line is quite wide. This high degree of variability indicates that the association is weak.
...
Overall, this graph suggests that the presence of American cuisine restaurants alone is unlikely to be a strong predictor of neighborhood obesity rates. Other factors—such as socioeconomic conditions, access to healthy foods, lifestyle behaviors, and overall dietary patterns—are likely more influential in shaping obesity prevalence across NYC neighborhoods.
```{r}
#| output: true
# diabetes plot
